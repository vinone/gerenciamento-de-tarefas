...
<body>
	<div class="container">
		...
		<div class="row-fluid">
			<form id="main-form" action="Tarefa/List" method="post" class="form-inline">
				<a class="btn btn-primary btn-large" href="#">Hoje</a>
				<a class="btn btn-large" href="#">Amanhã</a>
				<a class="btn btn-large" href="#">Próximos 7 dias</a>
				<input class="input-small" type="text" placeholder="dd/mm/aaaa" name="custom-date"></input>
